...
import cn.jianwoo.framework.config.properties.PermitAllUrlProperties;
import cn.jianwoo.framework.security.filter.JwtAuthenticationTokenFilter;
import cn.jianwoo.framework.security.handle.AuthenticationEntryPointImpl;
import cn.jianwoo.framework.security.handle.LogoutSuccessHandlerImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter
{
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception
    {
        ...
        httpSecurity
                ...
                .permitAll()
                .antMatchers("/v3/api-docs/**","/v3/api-docs/swagger-config", "/doc.html", "/swagger-resources/**", "/webjars/**",
                        "/*/api-docs", "/druid/**")
                .permitAll()
                // 除上面外的所有请求全部需要鉴权认证
