...
export function encryptPwd(txt) {
  const encryptor = new JSEncrypt()
  encryptor.setPublicKey(publicPwdKey) // 设置公钥
  return encryptor.encrypt(txt) // 对数据进行加密
}
