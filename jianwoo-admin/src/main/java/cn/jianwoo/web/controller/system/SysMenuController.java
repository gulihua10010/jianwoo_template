...
public class SysMenuController extends BaseController
{
    ...
    @BizOptLog(title = "菜单管理", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @BizOptLog(title = "菜单管理", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @BizOptLog(title = "菜单管理", businessType = BusinessType.DELETE)
