...
public class SysNoticeController extends BaseController
{
    ...
    @BizOptLog(title = "通知公告", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @BizOptLog(title = "通知公告", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @BizOptLog(title = "通知公告", businessType = BusinessType.DELETE)
