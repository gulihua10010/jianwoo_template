...
public class SysPostController extends BaseController
{
    ...
    @BizOptLog(title = "岗位管理", businessType = BusinessType.EXPORT)
    ...
    @BizOptLog(title = "岗位管理", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @BizOptLog(title = "岗位管理", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @BizOptLog(title = "岗位管理", businessType = BusinessType.DELETE)
