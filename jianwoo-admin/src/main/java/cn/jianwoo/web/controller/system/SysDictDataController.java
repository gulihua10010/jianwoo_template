...
public class SysDictDataController extends BaseController
{
    ...
    @BizOptLog(title = "字典数据", businessType = BusinessType.EXPORT)
    ...
    @BizOptLog(title = "字典数据", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @BizOptLog(title = "字典数据", businessType = BusinessType.UPDATE)
    @PutMapping
