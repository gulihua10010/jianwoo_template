...
import cn.jianwoo.common.core.domain.entity.SysDictType;
...
public class SysDictTypeController extends BaseController
{
    ...
    @BizOptLog(title = "字典类型", businessType = BusinessType.EXPORT)
    ...
    @BizOptLog(title = "字典类型", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @BizOptLog(title = "字典类型", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @BizOptLog(title = "字典类型", businessType = BusinessType.DELETE)
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:dict:remove')")
    @BizOptLog(title = "字典类型", businessType = BusinessType.CLEAN)
