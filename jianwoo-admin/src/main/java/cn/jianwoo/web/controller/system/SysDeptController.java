...
public class SysDeptController extends BaseController
{
    ...
    @BizOptLog(title = "部门管理", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @BizOptLog(title = "部门管理", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @BizOptLog(title = "部门管理", businessType = BusinessType.DELETE)
