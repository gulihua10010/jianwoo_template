...
public class SysProfileController extends BaseController
{
     ...
     * 修改用户
     */
    @BizOptLog(title = "个人信息", businessType = BusinessType.UPDATE)
    @PutMapping
     ...
     * 头像上传
     */
    @BizOptLog(title = "用户头像", businessType = BusinessType.UPDATE)
    @PostMapping("/avatar")
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(JianwooConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
