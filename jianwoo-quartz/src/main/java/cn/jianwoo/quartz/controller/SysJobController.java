package cn.jianwoo.quartz.controller;
...
import cn.jianwoo.common.exception.job.TaskException;
...
import cn.jianwoo.quartz.util.CronUtils;
import cn.jianwoo.quartz.util.ScheduleUtils;
...
public class SysJobController extends BaseController
{
    ...
    @BizOptLog(title = "定时任务", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    ...
    @BizOptLog(title = "定时任务", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @BizOptLog(title = "定时任务", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @BizOptLog(title = "定时任务", businessType = BusinessType.DELETE)
