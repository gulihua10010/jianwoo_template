...
import cn.jianwoo.generator.config.GenConfig;
...
public class GenUtils
{
    ...
    public static void initColumnField(GenTableColumn column, GenTable table)
    {
                ...
                || arraysContains(GenConstants.COLUMNTYPE_TEXT, dataType))
        {
            ...
            if ("char".equalsIgnoreCase(dataType) && columnLength == 1)
            {
                column.setJavaType(GenConstants.TYPE_BOOLEAN);

            }
        }
       else if (arraysContains(GenConstants.COLUMNTYPE_BYTE, dataType))
        {
        ...
        else if (arraysContains(GenConstants.COLUMNTYPE_NUMBER, dataType))
        {
            ...
            // 如果是整形
            else if ("bigint".equals(dataType) || str != null && str.length == 1 && Integer.parseInt(str[0]) > 10)
            {
...
//        column.setIsInsert(GenConstants.REQUIRE);
    ...
    {
        return GenConfig.getModuleName();
    }
    ...
    public static Integer getColumnLength(String columnType)
    {
        if (StringUtils.indexOf(columnType, "(") > 0)
        {
            ...
            if (length.contains(","))
            {
                int decimal = Integer.parseInt(length.substring(length.indexOf(",") + 1));
                return Integer.parseInt(length.substring(0, length.indexOf(","))) - decimal;
            }
